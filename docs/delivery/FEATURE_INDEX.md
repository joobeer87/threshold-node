...
| THS-F002 | Owner/per-grant auth separation | Implemented at API boundary | Pre-alpha |
| THS-F003 | Command policy gate | Validates/refuses; adapters unavailable | Partial |
| THS-F004 | Public-release hygiene | Synthetic fixtures, ignore rules, scan | Runnable |
| THS-F005 | Persistent append-only ledger | Not implemented | Planned |
