...
| THS-0021 | P2 | capture | Vision → zones/inventory extraction | GPT-5.6 observations → strict private proposal + digest-bound owner decision | src/threshold/capture/openai_vision.py,vision_proposals.py | 0020 | T1 | 120 | IN REVIEW | 90 | adapter + 39 focused tests + 190-test full gate; live synthetic model eval pending; never writes canonical THS |
