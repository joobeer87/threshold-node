...
| THS-0012 | P1 | housefile | Basic JSON store primitive | load/save synthetic housefile shell | src/threshold/housefile/store.py | 0002 | T1 | 30 | DONE | 65 | validated revision-CAS materialization remains THS-0023 |
...
| THS-0022 | P2 | capture | Boundary sketcher | deterministic digest-bound rectangular geometry from explicit room ordering | src/threshold/capture/geometry.py | 0021 | T2 | 60 | TODO | 0 | model never assigns access, no-go, or outdoor policy |
| THS-0023 | P2 | housefile | Owner-reviewed materialization | exact proposal/geometry digests + explicit access/outdoor choices + expected rev + schema-validated atomic commit | src/threshold/housefile/materialize.py | 0012,0015,0021,0022 | T1 | 90 | TODO | 0 | synthetic fixtures only until separate real-dwelling review; no automatic policy application |
...
| THS-0041 | P4 | hardware | stop interlock driver + SIM mode | serial listener → durable suspend_all + isolated halt_all; measure latency | src/threshold/hardware/estop.py | 0004,0016,0017 | T1 | 60 | TODO | 0 | prototype, not safety-rated; simulated software-path timing only until bench proof |
| THS-0042 | P4 | hardware | display.py states | ARMED/READ/DENY/TRIPPED | src/threshold/hardware/display.py | 0041 | T2 | 45 | TODO | 0 | deterministic terminal simulation required before DONE |
| THS-0043 | P4 | hardware | receipt.py printer | GRANT/DENY/ESTOP templates, PNG fallback | src/threshold/hardware/receipt.py | 0041 | T2 | 45 | TODO | 0 | deterministic synthetic fallback only |
| THS-0050 | P5 | console | MVP.jsx → live API | owner-auth canonical/grant/interlock/ledger views; no browser token persistence | console/ | 0014,0016,0017,0023,0041 | T1 | 120 | TODO | 0 | reference in /reference; React/Vite/TypeScript requires explicit package-install approval |
| THS-0051 | P5 | integration | E2E: grant→read→deny→estop | scripted run, ledger asserted | tests/integration/test_e2e.py | 0017,0035,0041 | T1 | 90 | TODO | 0 | |
...
| THS-0060 | P6 | docs | Demo video shoot + edit | DEMO-SCRIPT.md, 75s | media/ | 0021,0023,0041,0042,0043,0050,0051,0074 | T1 | 180 | TODO | 0 | D8; every shown behavior needs local proof and footage review |
